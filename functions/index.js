...
exports.onCreateFollower = functions.firestore
  ...
  exports.onDeleteFollower = functions.firestore
    ...
    exports.onCreatePost = functions.firestore
      ...
      // when a post is updated(like comment etc), add post to timeline of each follower (of post owner)
      //attention:here we use (change, context) insted of(snapshot, context)
